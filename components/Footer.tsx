        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-relaxed text-white/80 font-medium">
              Membentuk generasi Qur'ani yang berakhlak mulia, cerdas dan
              mandiri, serta mencintai Al-Qur'an sebagai pedoman hidup.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/tpqalhidayahkauman"
                target="_blank"
              ...
              <li className="flex items-start group">
                ...
                <a href="https://maps.app.goo.gl/YourMapLink">
                  <span className="font-medium text-white/80 leading-relaxed">
                    Jl. KH. Hasyim Asy'ari 52 Gg 3, Desa Kauman, Kec. Kauman,
                    Kab. Tulungagung.
                  </span>
                </a>
              </li>
